...
export const getAllAvailabilities = async (token) => {
    try {
        const response = await axios.get(`${API_BASE_URL}/grouped-by-user`, {
            headers: {
...
export const createAvailability = async (availabilityData, token) => {
    try {
        const response = await axios.post(`${API_BASE_URL}/create`, availabilityData, {
            headers: {
...
export const updateAvailability = async (availabilityId, updatedAvailability, token) => {
    try {
        const response = await axios.put(`${API_BASE_URL}/update/${availabilityId}`, updatedAvailability, {
            headers: {
                'Authorization': `Bearer ${token}`,
...
export const updateAvailabilityStatus = async (availabilityId, newStatus, token) => {
    try {
        const response = await axios.put(`${API_BASE_URL}/updateStatus/${availabilityId}?newStatus=${newStatus}`, null, {
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json' // Asegurar el tipo de contenido
...
export const getAvailabilityById = async (availabilityId, token) => {
    try {
        const response = await axios.get(`${API_BASE_URL}/${availabilityId}`, {
            headers: {
                'Authorization': token,
            },
        });
...
export const deleteAvailability = async (availabilityId, token) => {
    try {
        const response = await axios.delete(`${API_BASE_URL}/delete/${availabilityId}`, {
            headers: {
                'Authorization': token,
            },
        });
